...
console.log(createMenuItem("salmon", 12, "breakfast"));
console.log(createMenuItem("bahn mi", 14, "dinner"));
...
let yourDiscount = burger.discount("public");
console.log("Your discounted price is", yourDiscount);
